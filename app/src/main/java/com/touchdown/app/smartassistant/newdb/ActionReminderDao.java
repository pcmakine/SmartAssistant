...
public class ActionReminderDao extends newDao<NotificationReminder> {
    ...
    protected NotificationReminder buildObject(Cursor cursor) {
        ...
        NotificationReminder reminder = new NotificationReminder(id, type, content, isOn, actionCollectionId);
    ...
    public NotificationReminder findReminderByTaskId(long taskId){        //for now allows only one reminder per task
